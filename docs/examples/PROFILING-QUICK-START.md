# MINIX PROFILING TOOLS - QUICK START GUIDE

**Source**: README-PROFILING.md
**Date Organized**: 2025-11-01
**Purpose**: Quick-start guide for CPU profiling solution for MINIX 3.4 boot analysis
...
- [CLI Execution Guide](CLI-EXECUTION-GUIDE.md) - Complete command-line workflow
- [Runtime Setup Guide](RUNTIME-SETUP-GUIDE.md) - QEMU and Docker setup
- [MCP Quick Start](MCP-QUICK-START.md) - Model Context Protocol integration
- [Profiling Enhancement Guide](PROFILING-ENHANCEMENT-GUIDE.md) - Advanced profiling techniques
